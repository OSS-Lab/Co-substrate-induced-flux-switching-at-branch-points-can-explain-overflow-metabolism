...
def get_fluxfractions(pinit,params_inout, params01,
 ...
 #   print(Tmax,tpts)
    ...
    if np.any(final_concs):
        ...
        flux_bottom=ode_cm.flux_enz_forward(n2**al_p_24, 1., params_24[0], params_24[1])
  ...
  #  print(ff_delta)
   ...
   # if savepath != '':
    ...
    return ft_vec,fb_vec,fd_vec,ff_vec, ff_grad, ff_sens,ff_delta,gradmax,\
            gradmaxind,sensemax,sensemaxind,b0_delta,c0_delta,n0_delta,i
...
def make_params_nov25_allranges_nonfixed_nocosub(allo,n,VBmod,VCmod,KBmod,KCmod,diffval,diffscale):
    list_of_args=list()
    for i in range(n):
        # print(i)
        numkin=81
      ...
      #  print(ksvals)
        ...
        paramsE2=[4.05*randvals[8]/1000.,(0.14*randvals[9]),
                  (21*randvals[11]),6.8*10**4]   #PEP->PYR
...
def make_params_nov25_allranges_fixed_nocosub(allo,n,VBmod,VCmod,KBmod,KCmod,diffval,diffscale):
    list_of_args=list()
   # print(fixed,fasttrans,fastdiff,smallercosubs,fasterbackground,asymdiff)
    for i in range(n):
        # print(i)
