...
motifnone=img.imread('figS1_minimal_tr.png')
plt.imshow(motifnone)
plt.axis('off')

ax2=plt.axes([0.68,0.55,0.62,0.5])
plt.axis('off')
motifbranch=img.imread('figS1_branch_tr.png')
plt.imshow(motifbranch)

ax3=plt.axes([1.33,0.55,0.62,0.5])
plt.axis('off')
motifbranch=img.imread('figS1_branch_upstream_tr.png')
plt.imshow(motifbranch)
...
ax4=plt.axes([0.75,-0.6,0.52,0.55])
ax5=plt.axes([1.4,-0.6,0.52,0.55])
ax6=plt.axes([0.1,-0.6,0.52,0.55])

inset3=plt.axes([0.45,-0.5,0.15,0.15])
inset1=plt.axes([1.1,-0.25,0.15,0.15])
inset2=plt.axes([1.75,-0.5,0.15,0.15])
...
ax7=plt.axes([0.75,0.05,0.53,0.5])
...
ax7.set_xlabel('$\\rm B_{0,in}$',fontsize=30)
ax7.xaxis.set_label_coords(0.85,-0.05)
ax7.set_ylabel('$\\rm B_{deg}$',fontsize=30)
ax7.yaxis.set_label_coords(-0.1,0.6)
ax7.set_yticks(np.logspace(-4,2,4))
ax7.scatter(binoutvals[0],binoutvals[1],marker='o',color='k',s=100)
ax7.text(10**-6,10**1,'$\\rm E$', fontsize=40)
...
ax8=plt.axes([1.4,0.05,0.53,0.5])
...
ax8.set_xlabel('$\\rm B_{0,in}$',fontsize=30)
ax8.xaxis.set_label_coords(0.85,-0.05)
ax8.set_ylabel('$\\rm B_{deg}$',fontsize=30)
ax8.yaxis.set_label_coords(-0.1,0.6)
ax8.set_yticks(np.logspace(-4,2,4))
ax8.scatter(binoutvals[0],binoutvals[1],marker='o',color='k',s=100)
ax8.text(10**-6,10**1,'$\\rm F$', fontsize=40)
...
ax9=plt.axes([0.1,0.05,0.53,0.5])
...
ax9.set_xlabel('$\\rm B_{0,in}$',fontsize=30)
ax9.xaxis.set_label_coords(0.85,-0.05)
ax9.set_ylabel('$\\rm B_{deg}$',fontsize=30)
ax9.yaxis.set_label_coords(-0.1,0.6)
ax9.set_yticks(np.logspace(-4,2,4))
ax9.scatter(binoutvals[0],binoutvals[1],marker='o',color='k',s=100)
ax9.text(10**-6,10**1,'$\\rm D$', fontsize=40)
...
ax4.set_xscale('log')
# ax5.set_yscale('log')
ax4.legend(loc=(0.75,0.1),fontsize='large')
ax4.set_ylim(0,1)
ax4.set_xlabel('$v_{\\rm in}$',fontsize=30)
ax4.xaxis.set_label_coords(0.7,-0.05)
ax4.text(10**-4.6,0.86,'$\\rm H$', fontsize=40)
ax4.set_ylabel('$\\rm Flux~ Fraction$',fontsize=40)
ax4.yaxis.set_label_coords(-0.1,0.4)
ax4.text(10**-4.5,2.75,'$\\rm B$', fontsize=40)
...
inset1.yaxis.set_label_coords(-0.3,0.6)
...
inset2.yaxis.set_label_coords(-0.3,0.6)
...
for j in range(len(V24_vals)):
    ...
    inset3.plot(kinvals,b_vec,color=cols[j])#,linestyle=':') # add as inset
  
ax6.set_xscale('log')
# ax6.set_yscale('log')
# ax6.legend(loc=(0.6,0.05),fontsize='large')
ax6.legend(loc=(0.75,0.7),fontsize='large')
ax6.set_ylim(0,1)
ax6.set_xlabel('$v_{\\rm in}$',fontsize=30)
ax6.xaxis.set_label_coords(0.8,-0.05)
ax6.text(10**-4.6,0.86,'$\\rm G$', fontsize=40)
ax6.set_ylabel('$\\rm Flux~ Fraction$',fontsize=40)
ax6.yaxis.set_label_coords(-0.1,0.4)
ax6.text(10**-4.5,2.75,'$\\rm A$', fontsize=40)
...
inset3.yaxis.set_label_coords(-0.3,0.6)
