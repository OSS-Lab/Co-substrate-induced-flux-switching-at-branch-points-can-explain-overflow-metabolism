...
def make_ode_func(lengthparams=[3,2,2],B_position_params=([0,1,0],[0,0,0],[1,0],[1,0]),
    ...
    params=np.concatenate((params_inout, params_global, params_branch,params_B,bsynthdeg))
    # kin =             params[0]
    # kouttop =         params[1]
    # koutbottom =      params[2]
    ...
    def odefunc(P,t,params):
        ...
        rate_Binout=reac.Binout(P, params, lengthparams)
        
        rate_total = rate_kin + rate_kouttop + rate_koutbottom +rate_noB + \
            rate_B01 + rate_B10 + rate_Bback + rate_Binout
        return rate_total
