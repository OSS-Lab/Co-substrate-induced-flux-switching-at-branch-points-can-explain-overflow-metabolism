        ...
        if i != lengthparams[0]:
           ...
           for j in range(len(reac_out_indx)):
               if reac_out_indx[j]==1:
                   ...
                   rate_noB[i] += -reacf(P[i]**n, P[j], 1., 1., ckcat, ks**n, kp, keq)
                   rate_noB[j] += reacf(P[i]**n, P[j], 1., 1., ckcat, ks**n, kp, keq)
           ...
           for j in range(len(reac_out_indx)):
               if reac_out_indx[j]==1:
                #   print(str(j))
                   ...
                   rate_B01[i] += -reacf(P[i]**n, P[j], P[-2]**m, P[-1], ckcat, ks**(n+m), kp, keq)
                   rate_B01[j] += reacf(P[i]**n, P[j], P[-2]**m, P[-1], ckcat, ks**(n+m), kp, keq)
                   
                   rate_B01[-2] += -reacf(P[i]**n, P[j], P[-2]**m, P[-1], ckcat, ks**(n+m), kp, keq)
                   rate_B01[-1] += reacf(P[i]**n, P[j], P[-2]**m, P[-1], ckcat, ks**(n+m), kp, keq)
           ...
           for j in range(len(reac_out_indx)):
               ...
               if reac_out_indx[j]==1:
                #   print(str(j))
                   ...
                   rate_B10[i] += -reacf(P[i]**n, P[j], P[-1]**m, P[-2], ckcat, ks**(n+m), kp, keq)
                   rate_B10[j] += reacf(P[i]**n, P[j], P[-1]**m, P[-2], ckcat, ks**(n+m), kp, keq)
                   
                   rate_B10[-2] += reacf(P[i]**n, P[j], P[-1]**m, P[-2], ckcat, ks**(n+m), kp, keq)
                   rate_B10[-1] += -reacf(P[i]**n, P[j], P[-1]**m, P[-2], ckcat, ks**(n+m), kp, keq)
    return rate_B10
