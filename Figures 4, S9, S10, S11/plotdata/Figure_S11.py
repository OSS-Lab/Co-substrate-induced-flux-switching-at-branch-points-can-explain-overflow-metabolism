...
ax3.text(10**-8, 0.5, '$K_{\\rm eq}^c \\downarrow$',fontsize=50,
         bbox=boxstyle)
ax4.text(10**-8, 0.7, '$K_{\\rm eq}^c \\uparrow$',fontsize=50,
         bbox=boxstyle)
ax5.text(10**-8, 0.5, '$K_{\\rm eq}^m \\downarrow$',fontsize=50,
         bbox=boxstyle)
...
if savefig==1:
    ...
    plt.savefig('Figure_S11.png',bbox_inches='tight',format='png')
    plt.savefig('Figure_S11.eps',bbox_inches='tight',format='eps')
