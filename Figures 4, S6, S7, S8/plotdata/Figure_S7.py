...
ax14=plt.axes([0,0,0.9,1.15])
ax15=plt.axes([1,0,0.9,1.15])

# ax13=plt.axes([1.4,0.5,0.45,0.6])    # scatter 2
# ax16=plt.axes([0.15,0.5,0.45,0.6])    # scatter 2


ax15.text(-1.37,8.2,'$\\rm A$',fontsize=40)
ax15.text(-0.15,8.2,'$\\rm B$',fontsize=40)
...
ax14.hist(ff_delta,bins=binedges,alpha=0.5,color='b',density=True, 
            label='Table 1, with co-substrates')
...
ax14.hist(ff_delta,bins=binedges,alpha=0.5,color='r',density=True, 
            label='Table 1, without co-substrates')
# ax14.set_xlabel('flux frac delta')
ax14.legend(loc=(0.15,0.8))
...
ax15.hist(ff_delta,bins=binedges,alpha=0.5,color='seagreen',density=True, 
            label='\"fixed\ branch" parameters, with co-substrates')
...
ax15.hist(ff_delta,bins=binedges,alpha=0.5,color='r',density=True,
            label='\"fixed branch\" parameters, without co-substrates')
ax15.legend(loc=(0.15,0.8))
