...
diffvals=[10**-2.]#np.logspace(-6,0,7)
diffscales=[2.]
...
for al in aldo:
    ...
    for diffval in diffvals:
        for diffscale in diffscales:
            	...
            	args_to_run = mh_cm.make_params_nov25_allranges_nonfixed_nocosub(allo,n,VBmod,VCmod,KBmod,KCmod,diffval,diffscale)
...
for al in aldo:
    ...
    for diffval in diffvals:
        for diffscale in diffscales:
            	...
            	args_to_run =  mh_cm.make_params_nov25_allranges_fixed_nocosub(allo,n,VBmod,VCmod,KBmod,KCmod,diffval,diffscale)
            	now=dt.datetime.now()
            	print(now)
