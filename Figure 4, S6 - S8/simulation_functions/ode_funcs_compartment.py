...
def dm0dt(P,params_inout,params01,t):
    ...
    # VM01,Ks01_1,Ks01_2,Kp01_1,Kp01_2,Keq01=params01
   ...
   # print(1+m0*b0/Ks01+m1*b1/Kp01)
    return kin-mu_rev(m0,m1,b0,b1,VM01,Ks01,Kp01,Keq01)
...
def dm1dt(P,params01,params1E,t):
    ...
    return mu_rev(m0,m1,b0,b1,VM01,Ks01,Kp01,Keq01)-\
...
def dmEdt(P,params1E,paramsE2,t):
    ...
    # VME2,KsE2_1,KsE2_2,KpE2_1,KpE2_2,KeqE2=paramsE2
    
    # KsE2=KsE2_1*KsE2_2
    # KpE2=KpE2_1*KpE2_2
    
    return mu_rev(m1,mE,1.,1.,VM1E,Ks1E,Kp1E,Keq1E)-\
           mu_rev(mE,m2,1.29,2.52,VME2,KsE2,KpE2,KeqE2)
...
def dm2dt(P,paramsE2,params23,params_trans,allo,t):
    ...
    #        transp(m2,vt,kt)
    return mu_rev(mE,m2,1.29,2.52,VME2,KsE2,KpE2,KeqE2)-\
...
def dm3dt(P,params23,params35,params_diff_3,allo,t):
    ...
    # VM35,Ks35_1,Ks35_2,Kp35_1,Kp35_2,Keq35=params35
    ...
    return mu(m2**al_p_23, 1., VM23, Ks23) -\
           mu_rev(m3,m5,b1,b0,VM35,Ks35,Kp35,Keq35)-\
           diffn(m3,n3,ds3,df3)
...
def dm5dt(P,params_inout,params35,params_diff_5,t):
    ...
    return mu_rev(m3,m5,b1,b0,VM35,Ks35,Kp35,Keq35) -\
...
def dn2dt(P,params_24,params_trans,allo,t):
    ...
    return transp(m2,vt,kt) -\
        mu(n2**al_p_24,c0**al_b_24,VM_24,Ks_24)
...
def dn3dt(P,params_35,params_diff_3,t):
    ...
    # VM_35,Ks_35_1,Ks_35_2,Kp_35_1,Kp_35_2,Keq_35=params_35

    # Ks_35=Ks_35_1*Ks_35_2
    # Kp_35=Kp_35_1*Kp_35_2    
    
    ds3,df3=params_diff_3
    
    return mu_rev(n3,n5,c1,c0,VM_35,Ks_35,Kp_35,Keq_35)+\
        diffn(m3,n3,ds3,df3)
...
def dn5dt(P,params_35,params_diff_5,t):
    ...
    return mu_rev(n3,n5,c1,c0,VM_35,Ks_35,Kp_35,Keq_35) +  diffn(m5,n5,ds5,df5)
...
def dn4dt(P,params_24,params_inout,allo,t):
    ...
    return mu(n2**al_p_24,c0**al_b_24,VM_24,Ks_24)-\
...
def db0dt(P,params01,params35,paramsB,t):
    ...
    return - mu_rev(m0,m1,b0,b1,VM01,Ks01,Kp01,Keq01) +\
        mu_rev(m3,m5,b1,b0,VM35,Ks35,Kp35,Keq35) -\
        mu_rev(b0,b1,1.,1.,VMB,KsB,KpB,KeqB)

@numba.njit()        
def db1dt(P,params01,params35,paramsB,t):
    return -db0dt(P,params01,params35,paramsB,t)
...
def dc0dt(P,params_35,params_24,paramsC,allo,t):
    ...
    return -mu(n2**al_p_24,c0**al_b_24,VM_24,Ks_24)+\
        mu_rev(n3,n5,c1,c0,VM_35,Ks_35,Kp_35,Keq_35) -\
        mu_rev(c0,c1,1.,1.,VMC,KsC,KpC,KeqC)

@numba.njit()
def dc1dt(P,params_35,params_24,paramsC,allo,t):
    return -dc0dt(P,params_35,params_24,paramsC,allo,t)
