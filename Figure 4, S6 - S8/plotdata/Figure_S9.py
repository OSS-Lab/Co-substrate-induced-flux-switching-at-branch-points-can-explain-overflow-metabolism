...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 14 23:12:09 2025
...
indplot_switchretained=546 #570

plt.figure()

ax3=plt.axes([2.1,-0.6,0.9,1.1])    # fluxfraction
ax4=plt.axes([3.025,-0.6,0.9,1.1])    # expt
ax5=plt.axes([2.1,-1.75,0.9,1.1])    # fluxfraction
ax6=plt.axes([3.025,-1.75,0.9,1.1])    # expt

ax3.text(10**-8.,0.9,'$\\rm A$',fontsize=40)
ax4.text(10**-8.,0.9,'$\\rm B$',fontsize=40)
ax5.text(10**-8.,0.9,'$\\rm C$',fontsize=40)
ax6.text(10**-8.,0.9,'$\\rm D$',fontsize=40)

boxstyle=dict(facecolor='none', edgecolor='black', boxstyle='round,pad=0.1')
ax3.text(10**-8, 0.7, '$K_{\\rm eq}^c \\downarrow$',fontsize=50,
         bbox=boxstyle)
ax4.text(10**-8, 0.7, '$K_{\\rm eq}^c \\uparrow$',fontsize=50,
         bbox=boxstyle)
ax5.text(10**-8, 0.45, '$K_{\\rm eq}^m \\downarrow$',fontsize=50,
         bbox=boxstyle)
ax6.text(10**-8, 0.45, '$K_{\\rm eq}^m \\uparrow$',fontsize=50,
         bbox=boxstyle)
...
diffval=10**-2#np.logspace(-3,0,4)
diffscale=2.
...
ff_orig=1-flux24/(flux23+flux24)
# ff_new=1-flux24_5/(flux23_5+flux24_5)
swpt_orig=mh_cm.find_sw_pt(ff_orig,kinplot)
# ax5.plot([swpt_orig,swpt_orig],[0.2,0.6])
...
ax3.set_ylabel('${\\rm Flux ~Fraction,}~F_f$',fontsize=30)
...
ax4.set_yticks(np.linspace(0,1,6),['','','','','',''])#, ['$10^{-9}$','','$10^{-7}$','',
...
ax5.set_ylabel('${\\rm Flux ~Fraction,}~F_f$',fontsize=30)
# ax5.legend(loc='upper left',ncols=1)
ax5.set_xscale('log')
ax5.xaxis.set_label_coords(0.7,-0.025)
...
ax6.set_xscale('log')
ax6.xaxis.set_label_coords(0.7,-0.025)

ax6.set_xticks(np.logspace(-8,-5,4))#, ['$10^{-9}$','','$10^{-7}$','',
                                    # '$10^{-5}$','','$10^{-3}$',''])
ax6.set_yticks(np.linspace(0,1,6),['','','','','',''])#, ['$10^{-9}$','','$10^{-7}$','',
...
# ff_new=1-flux24_3/(flux23_3+flux24_3)
# swpt_3=mh_cm.find_sw_pt(ff_new,kinplot)
# ax3.plot([swpt_3,swpt_3],[0.2,0.6])
...
# swpt_4=mh_cm.find_sw_pt(ff_new,kinplot)
# ax4.plot([swpt_4,swpt_4],[0.2,0.6])
...
# ff_orig=1-flux24/(flux23+flux24)
# ff_new=1-flux24_5/(flux23_5+flux24_5)
# swpt_5=mh_cm.find_sw_pt(ff_new,kinplot)
# ax5.plot([swpt_5,swpt_5],[0.2,0.6])
...
# ff_new=1-flux24_6/(flux23_6+flux24_6)
# swpt_6=mh_cm.find_sw_pt(ff_new,kinplot)
# ax6.plot([swpt_6,swpt_6],[0.2,0.6])
...
# print((swpt_3-swpt_orig)*100/swpt_orig)
# print((swpt_4-swpt_orig)*100/swpt_orig)
# print((swpt_5-swpt_orig)*100/swpt_orig)
# print((swpt_6-swpt_orig)*100/swpt_orig)


if savefig==1:
    # plt.savefig('Figure4_supp.png',bbox_inches='tight',format='png')
    # plt.savefig('Figure4_supp.eps',bbox_inches='tight',format='eps')
    plt.savefig('Figure_S9.png',bbox_inches='tight',format='png')
    plt.savefig('Figure_S9.svg',bbox_inches='tight',format='svg')
    plt.savefig('Figure_S9.eps',bbox_inches='tight',format='eps')
